...
class AisDeployC():
    ...
    def model_initialize(self, path_str: str, gpu_id: int):
        """! The AisDeployC class models initializer.
         @see
         示例代码如下
         @code
         ...
         @endcode
        @param path_str models file path.
        @param gpu_id gpu id for models initialize
    ...
    def process(self, input_json: dict):
        ...
        @see
         ...
         @code
            ...
            imgPth = "tests/assets/images/deploy_image.jpg"
            f= open(imgPth, 'rb')
